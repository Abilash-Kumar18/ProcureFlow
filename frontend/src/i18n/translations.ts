export const translations = {
  en: {
    ...
    farmer: {
      ...
      greetingSub: 'Manage your procurement journey from booking to direct bank payment.',
      ...
      nav: {
        ...
        alerts: 'Alerts',
        profile: 'Profile',
        zoneTag: 'Thanjavur Zone • Kharif 2026'
      },
      quickActions: {
        bookSlot: 'Book a Slot',
        findCentre: 'Find a Centre',
        myBookings: 'My Bookings',
        trackProcPayment: 'Track Procurement & Payment'
      },
      journeyProgressTitle: 'Current Procurement Journey Progress',
      journeySteps: {
        booked: 'BOOKED',
        token: 'TOKEN',
        arrived: 'ARRIVED',
      ...
      recentAlertsTitle: 'Recent Alerts & Notifications',
      viewAllNotifications: 'View All Notifications →',
      liveQueuePage: {
        liveQueueBadge: 'LIVE QUEUE',
        updatedAt: 'Updated Real-Time',
        refreshBtn: 'Refresh',
        yourToken: 'YOUR VIRTUAL TOKEN',
        farmersAheadSuffix: 'farmers ahead of you',
        estimatedWait: 'Estimated wait: ~',
        currentlyServing: 'Currently Serving at Bay',
        checkInUponArrival: 'Check In Upon Arrival',
        checkedInGate: 'Checked in at gate. Please wait near bay.',
        liveStreamTitle: 'Live Queue Stream Order',
        nowServingBadge: 'NOW SERVING',
        yourTokenBadge: 'YOUR TOKEN',
    ...
    auth: {
      portalTitle: 'Procurement Portal Access',
      farmerLoginTab: 'Farmer Login',
      adminLoginTab: 'Admin Login',
      farmerNameLabel: 'Farmer Name / Username',
      farmerNamePlaceholder: 'Enter your name',
      mobileLabel: 'Mobile Number (10 Digits)',
      mobilePlaceholder: 'Enter 10-digit mobile number',
      mobileHelper: 'Numbers only (no letters or special characters)',
      otpLabel: 'Enter 4-Digit OTP',
      farmerSubmitBtn: 'Enter Farmer Portal',
      verifyingBtn: 'Verifying...',
      adminEmailLabel: 'Official Email ID',
      adminEmailPlaceholder: 'Enter email ID',
      adminPasswordLabel: 'Password',
      adminPasswordPlaceholder: 'Enter password',
      reqCapital: '1 Capital letter (A-Z)',
      reqSpecial: '1 Special character (!@#$)',
      reqNumber: '1 Number (0-9)',
      reqAlphabet: '1 Alphabet letter',
      adminSubmitBtn: 'Access District Command Center',
      ...
      errOtp4: 'Please enter the 4-digit OTP.',
      errAdminEmail: 'Please enter your official administrative email.',
      errAdminEmailValid: 'Please enter a valid email address.',
      errPasswordCapital: 'Password must contain at least 1 capital letter (A-Z).',
      errPasswordSpecial: 'Password must contain at least 1 special character (!@#$%^&*...).',
      errPasswordNumber: 'Password must contain at least 1 number (0-9).',
      errPasswordAlphabet: 'Password must contain at least 1 alphabet letter.'
    }
  },
  hi: {
    ...
    farmer: {
      welcome: 'नमस्ते,',
      greeting: 'सुप्रभात,',
      greetingSub: 'बुकिंग से लेकर सीधे बैंक भुगतान तक अपनी खरीद यात्रा का प्रबंधन करें।',
      ...
      nav: {
        ...
        alerts: 'अलर्ट्स',
        profile: 'प्रोफ़ाइल',
        zoneTag: 'तंजावुर क्षेत्र • खरीफ 2026'
      },
      quickActions: {
        bookSlot: 'स्लॉट बुक करें',
        findCentre: 'केंद्र खोजें',
        myBookings: 'मेरी बुकिंग',
        trackProcPayment: 'खरीद एवं भुगतान ट्रैक करें'
      },
      journeyProgressTitle: 'वर्तमान खरीद प्रक्रिया प्रगति',
      journeySteps: {
        booked: 'बुक किया',
        token: 'टोकन',
        arrived: 'आगमन',
        queueCurrent: 'कतार (वर्तमान)',
        procurement: 'खरीद',
        payment: 'भुगतान'
      },
      recentAlertsTitle: 'हालिया अलर्ट और सूचनाएं',
      viewAllNotifications: 'सभी सूचनाएं देखें →',
      liveQueuePage: {
        liveQueueBadge: 'लाइव कतार',
        updatedAt: 'रीयल-टाइम अपडेट',
        refreshBtn: 'रिफ्रेश करें',
        yourToken: 'आपका वर्चुअल टोकन',
        farmersAheadSuffix: 'किसान आपसे आगे हैं',
        estimatedWait: 'अनुमानित प्रतीक्षा: ~',
        currentlyServing: 'काउंटर पर सेवारत',
        checkInUponArrival: 'आगमन पर चेक-इन करें',
        checkedInGate: 'गेट पर चेक-इन पूर्ण हुआ। कृपया बे के पास प्रतीक्षा करें।',
        liveStreamTitle: 'लाइव कतार क्रम',
        nowServingBadge: 'वर्तमान में सेवारत',
        yourTokenBadge: 'आपका टोकन',
        upcomingBadge: 'आगामी'
      },
    ...
    auth: {
      portalTitle: 'खरीद पोर्टल प्रवेश',
      farmerLoginTab: 'किसान लॉगिन',
      adminLoginTab: 'प्रशासन लॉगिन',
      farmerNameLabel: 'किसान का नाम / यूजरनेम',
      ...
      mobileHelper: 'केवल संख्यात्मक अंक (विशेष वर्ण या अक्षर नहीं)',
      otpLabel: '4 अंकों का ओटीपी दर्ज करें',
      farmerSubmitBtn: 'किसान पोर्टल में प्रवेश करें',
      verifyingBtn: 'सत्यापित किया जा रहा है...',
      adminEmailLabel: 'आधिकारिक ईमेल आईडी',
      adminEmailPlaceholder: 'ईमेल आईडी दर्ज करें',
      adminPasswordLabel: 'पासवर्ड',
      adminPasswordPlaceholder: 'पासवर्ड दर्ज करें',
      reqCapital: '1 बड़ा अक्षर (A-Z)',
      reqSpecial: '1 विशेष वर्ण (!@#$)',
      reqNumber: '1 संख्या (0-9)',
      reqAlphabet: '1 वर्णमाला अक्षर',
      adminSubmitBtn: 'जिला कमान केंद्र में प्रवेश करें',
      authenticatingBtn: 'प्रमाणीकरण जारी...',
      errEnterName: 'कृपया अपना पूरा नाम दर्ज करें।',
      errMobile10: 'मोबाइल नंबर ठीक 10 अंकों का होना चाहिए।',
      errOtp4: 'कृपया 4 अंकों का ओटीपी दर्ज करें।',
      errAdminEmail: 'कृपया अपना आधिकारिक ईमेल दर्ज करें।',
      errAdminEmailValid: 'कृपया एक मान्य ईमेल पता दर्ज करें।',
      errPasswordCapital: 'पासवर्ड में कम से कम 1 बड़ा अक्षर (A-Z) होना चाहिए।',
      errPasswordSpecial: 'पासवर्ड में कम से कम 1 विशेष वर्ण (!@#$%^&*...) होना चाहिए।',
      errPasswordNumber: 'पासवर्ड में कम से कम 1 संख्या (0-9) होनी चाहिए।',
      errPasswordAlphabet: 'पासवर्ड में कम से कम 1 अक्षर होना चाहिए।'
    }
  },
  ta: {
    ...
    farmer: {
      ...
      greetingSub: 'முன்பதிவு முதல் நேரடி வங்கி வரவு வரை உங்கள் கொள்முதல் பயணத்தை எளிதாக நிர்வகிக்கவும்.',
      nextProcurement: 'உங்கள் அடுத்த கொள்முதல்',
      arrivalPrefix: 'வருகை நேரம்:',
      datePrefix: 'தேதி:',
      trackLiveQueue: 'நேரடி வரிசையை காண்க',
      viewBookingDetails: 'முன்பதிவு விவரங்கள்',
      nav: {
        home: 'முகப்பு',
        ...
        alerts: 'அறிவிப்புகள்',
        profile: 'சுயவிவரம்',
        zoneTag: 'தஞ்சாவூர் மண்டலம் • காரீப் 2026'
      },
      quickActions: {
        bookSlot: 'நேரம் முன்பதிவு செய்க',
        findCentre: 'மையத்தை தேடுக',
        myBookings: 'எனது முன்பதிவுகள்',
        trackProcPayment: 'கொள்முதல் & பண வரவு'
      },
      journeyProgressTitle: 'தற்போதைய கொள்முதல் செயல்முறை முன்னேற்றம்',
      journeySteps: {
        booked: 'முன்பதிவு',
        token: 'டோக்கன்',
        arrived: 'வருகை',
        queueCurrent: 'வரிசை (தற்போது)',
        procurement: 'கொள்முதல்',
        payment: 'பணம் வரவு'
      },
      recentAlertsTitle: 'சமீபத்திய விழிப்பூட்டல்கள் & அறிவிப்புகள்',
      viewAllNotifications: 'அனைத்து அறிவிப்புகளையும் காண்க →',
      liveQueuePage: {
        liveQueueBadge: 'நேரடி வரிசை',
        updatedAt: 'தற்போதைய நேரலை',
        refreshBtn: 'புதுப்பிக்க',
        yourToken: 'உங்கள் டோக்கன் எண்',
        farmersAheadSuffix: 'விவசாயிகள் உங்களுக்கு முன்னால்',
        estimatedWait: 'மதிப்பிடப்பட்ட காத்திருப்பு: ~',
        currentlyServing: 'எடை மேடையில் தற்போது',
        checkInUponArrival: 'வந்தவுடன் செக்-இன் செய்க',
        checkedInGate: 'வாயிலில் வருகை பதிவு செய்யப்பட்டது. எடை மேடை அருகில் காத்திருக்கவும்.',
        liveStreamTitle: 'நேரடி வரிசை ஓட்டம்',
        nowServingBadge: 'தற்போது அழைக்கப்படுபவர்',
        yourTokenBadge: 'உங்கள் டோக்கன்',
        upcomingBadge: 'அடுத்தது'
      },
    ...
    auth: {
      portalTitle: 'நேரடி கொள்முதல் போர்ட்டல் உள்நுழைவு',
      farmerLoginTab: 'விவசாயி உள்நுழைவு',
      adminLoginTab: 'நிர்வாகி உள்நுழைவு',
      farmerNameLabel: 'விவசாயியின் பெயர் / பயனர் பெயர்',
      farmerNamePlaceholder: 'உங்கள் பெயரை உள்ளிடவும்',
      mobileLabel: 'கைபேசி எண் (10 இலக்கங்கள்)',
      mobilePlaceholder: '10 இலக்க கைபேசி எண்ணை உள்ளிடவும்',
      mobileHelper: 'எண்கள் மட்டுமே (எழுத்துக்கள் அல்லது குறியீடுகள் கூடாது)',
      otpLabel: '4 இலக்க OTP குறியீட்டை உள்ளிடவும்',
      farmerSubmitBtn: 'விவசாயி போர்ட்டலுக்குள் நுழைக',
      verifyingBtn: 'சரிபார்க்கப்படுகிறது...',
      adminEmailLabel: 'அதிகாரப்பூர்வ மின்னஞ்சல் முகவரி',
      adminEmailPlaceholder: 'மின்னஞ்சல் முகவரியை உள்ளிடவும்',
      adminPasswordLabel: 'கடவுச்சொல்',
      adminPasswordPlaceholder: 'கடவுச்சொல்லை உள்ளிடவும்',
      reqCapital: '1 பெரிய எழுத்து (A-Z)',
      reqSpecial: '1 சிறப்பு குறியீடு (!@#$)',
      reqNumber: '1 எண் (0-9)',
      reqAlphabet: '1 ஆங்கில எழுத்து',
      adminSubmitBtn: 'மாவட்ட கட்டுப்பாட்டு மையத்திற்குள் நுழைக',
      authenticatingBtn: 'அங்கீகரிக்கப்படுகிறது...',
      errEnterName: 'தயவுசெய்து உங்கள் முழு பெயரை உள்ளிடவும்.',
      errMobile10: 'கைபேசி எண் சரியாக 10 இலக்கங்களாக இருக்க வேண்டும்.',
      errOtp4: 'தயவுசெய்து 4 இலக்க OTP குறியீட்டை உள்ளிடவும்.',
      errAdminEmail: 'தயவுசெய்து உங்கள் அதிகாரப்பூர்வ மின்னஞ்சலை உள்ளிடவும்.',
      errAdminEmailValid: 'தயவுசெய்து சரியான மின்னஞ்சல் முகவரியை உள்ளிடவும்.',
      errPasswordCapital: 'கடவுச்சொல்லில் குறைந்தபட்சம் 1 பெரிய எழுத்து (A-Z) இருக்க வேண்டும்.',
      errPasswordSpecial: 'கடவுச்சொல்லில் குறைந்தபட்சம் 1 சிறப்பு குறியீடு (!@#$%^&*...) இருக்க வேண்டும்.',
      errPasswordNumber: 'கடவுச்சொல்லில் குறைந்தபட்சம் 1 எண் (0-9) இருக்க வேண்டும்.',
      errPasswordAlphabet: 'கடவுச்சொல்லில் குறைந்தபட்சம் 1 எழுத்து இருக்க வேண்டும்.'
    }
  }
};
